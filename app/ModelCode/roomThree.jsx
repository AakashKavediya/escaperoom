...
const FirstPersonControls = ({ onPositionUpdate }) => {
  ...
  const boundary = {
    points: [
      new THREE.Vector3(2.64, 3.00, 2.41),   // Point 1
      new THREE.Vector3(-2.47, 3.00, 2.63),  // Point 2
  ...
  // Movement parameters - decreased by 30%
  const moveSpeed = 0.0168; // Reduced from 0.024 by 30%
  const damping = 0.8;
  ...
  useFrame(() => {
    ...
    // Apply movement speed (30% reduced)
